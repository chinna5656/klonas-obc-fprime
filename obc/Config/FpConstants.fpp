# ======================================================================
# FPP file for configuration of various F Prime framework constants (STM32F411 Optimized)
# ======================================================================
...
constant FW_QUEUE_NAME_BUFFER_SIZE = 32

@ Specifies the size of the string holding the task name for active components and tasks
constant FW_TASK_NAME_BUFFER_SIZE = 32

@ Specifies the size of the buffer that contains a communications packet (sized for LoRa/UART)
constant FW_COM_BUFFER_MAX_SIZE = 144
...
constant FW_CMD_STRING_MAX_SIZE = 32
...
constant FW_TLM_STRING_MAX_SIZE = 32
...
constant FW_PARAM_STRING_MAX_SIZE = 32
