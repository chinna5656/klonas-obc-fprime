module obc {
  ...
  # ----------------------------------------------------------------------
    ...
    instance comDriver
    instance cmdSeq
    instance navPredictor
    instance parachuteDeployer
    instance commsCrypto
    instance envSensors
  ...
  # ----------------------------------------------------------------------
    ...
    # include "KlonasDeploymentPackets.fppi"
  ...
  # ----------------------------------------------------------------------
    ...
    connections RateGroups {
      ...
      rateGroup2.RateGroupMemberOut[1] -> commsCrypto.schedIn
      rateGroup2.RateGroupMemberOut[2] -> powerMonitor.schedIn

      # Rate group 3 (Low Rate / Log Flush)
      ...
      rateGroup3.RateGroupMemberOut[5] -> dataLogger.schedIn
    }
    ...
    connections KlonasDeployment {
      # Navigation predictor triggers automatic parachute deployment
      navPredictor.deployOut -> parachuteDeployer.deployIn
    }
